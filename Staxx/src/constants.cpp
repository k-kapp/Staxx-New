...
const int DESIGN_SELECT_BLOCK_SIZE = 120;
const int DESIGN_SELECT_SCROLLER_SIZE = DESIGN_SELECT_BLOCK_SIZE / 3;
const int DESIGN_SELECT_SCREEN_WIDTH = 800;
const int DESIGN_SELECT_SCREEN_HEIGHT = 600;
